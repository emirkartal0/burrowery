...
function AccordionBar({ openAccordion, setOpenAccordion, accordion, index }) {
    ...
    return (
        <div className='w-10/12 px-3 pt-2 flex flex-col content-center'>
            <div className='flex w-full items-center flex-row gap-5 shadow-sm py-0.5'>
                ...
                <div className='w-full'>
                    <div className='flex w-full items-center font-semibold border-t pt-1'>{accordion?.title}</div>
