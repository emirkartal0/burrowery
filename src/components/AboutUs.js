    ...
    return (
        <div>
            <div className="flex flex-col justify-center items-center p-10 bg-about w-full h-3/4">
                ...
                <button
                    type="button"
                    class="focus:outline-none text-white bg-green hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2"
                >
                    Green
                </button>
            </div>
